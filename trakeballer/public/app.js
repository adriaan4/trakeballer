...
const LOGOS_LIGA = {
  ...
  'laliga': 'espana.png', 'ligue-1': 'francia.png', 'premier-league': 'inglaterra.png', 'serie-a': 'italia.png',
...
function logoLiga(l) {
  return LOGOS_LIGA[l.id] ? `img/escudos/ligas/${LOGOS_LIGA[l.id]}` : `img/escudos/ligas-${l.id}.svg`;
}
